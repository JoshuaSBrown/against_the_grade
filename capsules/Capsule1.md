...
### Phased Deployment Design

**Phase One --- Robotic Terraforming (\~400 years before human emergence).**
Autonomous, self-replicating machines performed atmospheric processing, soil
creation, and ecosystem bootstrapping. Pure infrastructure work with no
biological component. This phase visibly transformed the planet --- atmospheric
changes, energy signatures, industrial activity broadcasting across the region.

**Phase Two --- Ecosystem Seeding.** The bio labs produced engineered organisms
in staged ecological packages --- targeted seed populations released in matched
cohorts. Early stages produced simple organisms for ecosystem completion.
Intermediate stages produced more complex, more adaptable creatures.

**Phase Three --- Human Production.** Humans were the final biological stage,
designed to emerge only when the planet could fully support human life. The bio
lab produced approximately 200 children across age cohorts, from infants through
children up to approximately age 10. Robotic caretakers provided interactive
childcare, language acquisition, and age-appropriate education.

**Phase Four --- Education and Activation (never completed).** The curriculum
explaining human origins, Earth's history, the capsule program, and the symbiont
system was scheduled for pre-adolescence through adolescence. Symbiont
activation via AI upload was scheduled for biological maturity. Full knowledge
transfer and technological capability unlock would follow.
...
Capsule 1 arrived intact. All systems functional. It entered its staged
biological sequence as designed, producing ecosystem organisms through
intermediate stages and eventually producing approximately 200 human children
across age cohorts.

### The Ulreth Attack

The Ulreth --- produced a century earlier by damaged Capsule 2 --- had been
established as a territorial species in their own region. They encountered
Capsule 1's facility not out of strategy but out of resource-seeking instinct.
They were scavenging, not invading. They didn't understand what the facility
was.
...
parents and leaders of the surviving group. Within two to three generations,
even the oldest children's memories of the facility became mythology. "The metal
mothers." "The before-place." Creation myths built from fragmentary childhood
...
Capsule 1 has been surrounded by human settlement for centuries. It is not a
frontier discovery --- it is a known location within the religious community's
territory. Accessing it is a political problem, not an exploration problem.

**Physical condition:** The capsule's outer structure has likely been
incorporated into later construction over the centuries --- its armor walls
repurposed as building foundations, its internal chambers used as storage,
shelter, or ceremonial spaces. The facility is a place humans have lived around
and built upon without understanding what it originally was.
...
Capsule 1's data corruption is primarily physical --- systems damaged during the
Ulreth raid, compounded by centuries of neglect without maintenance. This means
the corruption is uneven and somewhat random: some database sectors survived
intact, others are completely destroyed, and the boundaries between functional
and corrupted data are unpredictable. Baret may find a complete technical
document adjacent to a corrupted file that's unreadable.

### Strengths

Capsule 1 is the strongest source for terraforming infrastructure documentation,
ecosystem design records, and partial educational archives. Because it was the
primary human production capsule and arrived intact, its records about the
planet itself --- what was built, where infrastructure was placed, how the
ecosystem was designed --- are the most complete of the three capsules.

### Weaknesses

Capsule 1's records of Earth's AI crisis are fragmentary. Baret cannot learn the
full story of memory manipulation from Capsule 1 alone. The military AI
specifications exist somewhere in the educational database but data corruption
makes them inaccessible. Baret gets enough to form a conceptual framework by
Book 4 but not enough to suspect memory manipulation is happening on his planet
until Book 5 evidence accumulates.

### Relationship to Other Capsules

Capsule 1 and Baret's Capsule 2 AI provide complementary but sometimes
contradictory information. Baret's AI (loaded from Capsule 2's corrupted
databases) contains fragmentary references that occasionally overlap with or
contradict Capsule 1's archives. Neither version is complete. This forces Baret
to think critically about every source rather than accepting any single account
as authoritative.

Capsule 3 (Kullen's source) holds more complete digital archives, including the
military AI documentation that Capsule 1 can't provide. The information
...
it exists after his activation but cannot access it. The religious community
controls the territory.

**Book 2:** Baret's awareness of Capsule 1 grows. His AI (loaded from Capsule 2)
contains fragmentary references to it. Post-war, access to Capsule 1 becomes a
geopolitical question --- it sits in what is becoming the religious leader's
territory. Baret's alliance with the religious leader is partly motivated by the
desire to access it.

**Book 3:** The primary capsule discovery book. Baret breaks into Capsule 1
after the religious leader refuses access (the religious leader is withholding
...
doing the exact thing he condemns in others (deciding unilaterally who gets to
know what), but he rationalizes it rather than recognizing the hypocrisy.

**Book 4:** Additional Capsule 1 records are accessed as Baret searches for
information about gene therapy and the symbiont architecture (directly relevant
to political debates about genetic inequality). The Earth backstory emerges in
pieces --- references to weaponized AI, memory manipulation as a historical
concept, the cascading trust failure that ended Earth's civilization. This
information arrives as context Baret needs for present problems, not as a
history lesson.

**Book 5:** Capsule 1's records provide the foundation Baret needs to form his
hypothesis about what's happening to his republic. He connects the Earth AI
crisis documentation from Book 4 to the behavioral anomalies he's observing in
